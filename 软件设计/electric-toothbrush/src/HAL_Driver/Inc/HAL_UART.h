...
typedef struct
{
	...
	uint32_t FIFOEn;					/*!< Specifies whether the fifo is enable or disable. */
	
	uint32_t FIFOTriggerLen_RX;			/*!< Specifies that how many data received in fifo will trigger the interrup.
											 This parameter would just be used in RX Interrupt mode with enabling FIFO,
											 and can be set a value of @ref UART_RX_FIFO_1_2. */
	uint32_t FIFOTriggerLen_TX;			/*!< Specifies that how many data received in fifo will trigger the interrup.
											 This parameter would just be used in TX Interrupt mode with enabling FIFO,
											 and can be set a value of @ref UART_TX_FIFO_1_2. */
